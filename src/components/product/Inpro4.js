...
const Inpro4 = (props) => {
  ...
  const ToLocalStorage = (value) => {
    const newCart = hotInex4;
    localStorage.setItem(hotInex4.product_name, JSON.stringify(newCart));
  };
        ...
        <div className="d-flex justify-content-evenly align-items-center inpr04">
          <div className="text-dark text-decoration-none text-center">
            <div className="recommendProductBox position-relative">
              ...
              <img alt="" className="inproflag" src="/img/product/tiger.png" />
...
export default withRouter(Inpro4);
