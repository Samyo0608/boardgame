...
function Index(props) {
  const [contest, setContest] = useState(contestRun(contestItems));
      ...
      <div className="searchBar row">
        <div className="d-flex">
          ...
          <form action="" className="d-inline">
            ...
            <label For="card" className="fs-3 fontColor">
              卡牌
            </label>
            <input type="checkbox" className="" value="" id="family" />
            <label for="family" className="fs-3 fontColor">
              家庭
            </label>
            <input type="checkbox" className="" value="" id="stategy" />
            <label for="stategy" className="fs-3 fontColor">
              {" "}
              策略
            </label>
